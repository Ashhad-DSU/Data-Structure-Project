...
int main()
{
	...
	cout<<"--------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> Najmus Sehar Shimail <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<">>>----Project Implemented By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"MUHAMMAD ANAS SHEIKH (CS201079)"<<endl;
   	gotoxy(22,16);
    cout<<"MUHAMMAD ASHHAD SAFWAN (CS201081)"<<endl;
   	gotoxy(22,17);
   	cout<<"MUHAMMAD HAMZA SIDDIQUI (CS201083)"<<endl;
   	gotoxy(22,18);
   	cout<<"MUHAMMAD SAAD AMIN  (CS201091)"<<endl<<endl;
	system("pause");
	system("cls");
	system("color Fc");
